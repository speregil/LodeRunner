...
public class Player : MonoBehaviour {
	...
	void Start()
    {
		...
		shootParent = transform.Find("PadreDisparo");
		shootRenderer = GameObject.Find("Disparo").renderer;
		shootSprite = GameObject.Find("Disparo").GetComponent<OTAnimatingSprite>();
    }
